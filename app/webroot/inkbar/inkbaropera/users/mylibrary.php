            ...
            <tr>
                <td align="center">
                    <table width="50%" cellpadding="5" border="1">
                       ...
                       ?>
                                        <tr>
                                            <td><?php echo $count; ?></td><td><?php echo $show['url']; ?></td><td><a target="_blank" href= "/toolbaropera/users/ShowAnnotaionPage.php?dom=<?php echo $show['id']; ?>"><?php echo $show['title']; ?></a></td>
                                        </tr>
