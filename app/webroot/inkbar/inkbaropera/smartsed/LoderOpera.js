...
function createLoaderSpanElement(){
    if(document.getElementById("toolbarContainer")==null && document.getElementById("loaderSpanElement")==null){
        ...
        loaderSpandiv.style.zIndex = "999999";
        ...
        loaderSpanEle.appendChild(document.createTextNode("Loading Dr. Smarts Toolbar..."));
        loaderSpandiv.appendChild(loaderSpanEle);

        var loaderImg = document.createElement("img");
        loaderImg.src = "http://www.smartsed.com/smartsed/app/webroot/inkbar/inkbaropera/icons/ajax-loader.gif"; //baseURL + "/smartsed/icons/ajax-loader.gif";
        loaderSpanEle.appendChild(loaderImg);

        document.body.insertBefore(loaderSpandiv, document.body.firstChild);

        var x = (window.innerWidth / 2) - (loaderSpandiv.offsetWidth / 2);
        var y = (window.innerHeight / 2) - (loaderSpandiv.offsetHeight / 2);
        loaderSpandiv.style.top = y + "px";
        loaderSpandiv.style.left = x + "px";

        if(addScript()){
            //var drsmartsMozilla=document.createElement('script');drsmartsMozilla.src=baseURL + "/toolbaropera" + '/smartsed/class_Drsmarts_Mozilla.js';drsmartsMozilla.setAttribute('id', 'drsmartsMozilla');document.body.appendChild(drsmartsMozilla);
        }
...
function addScript(){
    try{
        ...
        var e=document.createElement('script');e.src=seftURL + '/smartsed/class_DBConnect.js';e.setAttribute('id', 'Dr5');document.body.appendChild(e);
        var myCss = document.createElement('link');myCss.href= seftURL + '/smartsed/css/opera.css';myCss.setAttribute('rel', 'stylesheet');myCss.setAttribute('type', 'text/css');document.body.appendChild(myCss);
...
function loadToolbar(){
    var drsmartsOpera=document.createElement('script');drsmartsOpera.src=baseURL + '/smartsed/class_Drsmarts_Mozilla.js';drsmartsOpera.setAttribute('id', 'drsmartsOpera');document.body.appendChild(drsmartsOpera);
}