...
function createStickyNotes(selection, callingObj){
    ...
    makePostRequestforCategoryStickyNotes();
    ...
    try{
        ...
        var stickyNoteInnerHTML = '<div class ="stickyTitle" onmousedown="dragDropElements.startDragMouse(event)" id="'+ divIDStickyNotes +'" style="-moz-box-shadow : inset 0px 0px 70px 1px '+callingObj.style.backgroundColor+';box-shadow : inset 0px 0px 70px 1px '+callingObj.style.backgroundColor+';">';
        ...
        stickyNoteInnerHTML += '<tr><td ><input style="width:98%" id="'+ guidTitleTextField +'"type="text" placeholder="Tag"/></td></tr>';
        ...
        //selection.focusNode.parentNode.innerHTML += '<span><img src="' + baseURL +'/drsmarts-toolbar/drsmarts/icons/note.png"/><span>'
...
function minimizeStickyNotes(objThis){
    ...
    focusNodeStickyNodes.innerHTML += '<span id="img'+ parent.id +'" onClick = "showStickyNotes(this)"><img src="http://www.smartsed.com/smartsed/app/webroot/inkbar/inkbarmozila/smartsed/icons/min.gif"/><span>';
...
function makePostRequestforCategoryStickyNotes(){
    $.ajax({
        type: 'POST',
