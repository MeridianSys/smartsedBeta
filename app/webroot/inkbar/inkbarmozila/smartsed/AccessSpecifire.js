...
function createAccessSpecifireLayer(id,left,top, obj){
    ...
    tableASL1 = tableASL1 + '<table><tr><td align="left" width="90%">Mode</td><td width="30%" align="right"><img src=' + baseURL +'"/smartsed/icons/Close.png" onClick="closeAccessSpecifire()"></td></tr></table></td></tr><tr><td>';
