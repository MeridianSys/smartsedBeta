...
class ImageComponent extends Object
{
    ...
    */
    function upload_image_and_thumbnail($data, $datakey, $imgscale, $thumbscale, $folderName, $square) {
        ...
        if (strlen($data['User'][$datakey]['name'])>4){
                    $error = 0;
                    ...
                    $filetype = $this->getFileExtension($data['User'][$datakey]['name']);
                    ...
                    {
                        // Get the image size
                        $imgsize = GetImageSize($data['User'][$datakey]['tmp_name']);
                    }
                    ...
                    if (is_uploaded_file($data['User'][$datakey]['tmp_name']))
                    {
                        // Copy the image into the temporary directory
                        if (!copy($data['User'][$datakey]['tmp_name'],"$tempfile"))
                        {
