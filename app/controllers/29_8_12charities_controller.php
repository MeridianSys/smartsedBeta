...
class CharitiesController extends AppController {
	 ...
	 var $layout = 'admin';
	 var $uses = array('User','Userprofile','Admin','Charity','users_professional_tracks','Institution_list','Charityuser','Quizuserattempt','Charityuserfriend','Edivcharityvalue');
